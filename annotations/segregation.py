...
image_dir = "\gun dataset\gun for labelimg dataset"
label_dir = "\gun dataset\labelimg output"
matched_dir = "\gun dataset\matched_dir"
unmatched_dir = "\gun dataset\unmatched_dir"
