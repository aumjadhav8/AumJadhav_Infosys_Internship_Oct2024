...
# Load the known image of Person
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Aum'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel('aum_attendance_save.xlsx', index=False)
...
if not df.empty:
    df.to_excel('aum_attendance.xlsx', index=False)
