...
try:
    while True:
        ...
        if (datetime.now() - last_saved_time).total_seconds() >= 30:
            df.to_excel('aum_attendance_with_screenshots_dt.xlsx', index=False)
            print("Data saved to 'aum_attendance_with_screenshots_dt.xlsx'.")
    ...
    if not df.empty:
        df.to_excel('aum_attendance_with_screenshots_dt.xlsx', index=False)
        print("Attendance and screenshots saved to 'aum_attendance_with_screenshots_dt.xlsx'.")
