...
p = "/home/zaphieyr/PycharmProjects/pythonProject/facial-landmarks-recognition/shape_predictor_68_face_landmarks.dat"
...
try:
    while True:
        ...
        if time.time() - start_time >= 30:
            ...
            if not df.empty:
                df.to_excel('Aum_attendance_with_attention_and_average.xlsx', index=False)
                print("Attendance saved to 'Aum_attendance_with_attention_and_average.xlsx'.")
    ...
    if not df.empty:
        ...
        df.to_excel('Aum_attendance_with_attention_and_average.xlsx', index=False)
        print("Attendance with attentiveness and average score saved to 'Aum_attendance_with_attention_and_average.xlsx'.")
